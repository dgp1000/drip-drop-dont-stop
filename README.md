...
GO chord, and a carve scritch. Visuals: gradient backdrop, glint + speed-fed
motion trail on the droplet (blue as water, white as ice), splash burst on
death, celebration burst at the goal.
